...
export const Secondary: Story = { args: { variant: 'secondary', label: 'Add note' } };
export const Ghost: Story = { args: { variant: 'ghost', label: 'Cancel' } };
export const Danger: Story = { args: { variant: 'danger', label: 'Delete program' } };
export const Small: Story = { args: { size: 'sm', label: 'Save' } };
export const Large: Story = { args: { size: 'lg', label: 'Start session' } };
  ...
  render: () => ({
    template: `
      <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;padding:24px;background:var(--bg-0)">
        <ds-button variant="primary" size="sm" label="Add set">${PLUS_ICON}</ds-button>
        <ds-button variant="primary" size="md" label="Add set">${PLUS_ICON}</ds-button>
        <ds-button variant="primary" size="lg" label="Add set">${PLUS_ICON}</ds-button>
      </div>
    `,
    moduleMetadata: { imports: [ButtonComponent] },
  }),
...
export const WithIconTrailing: Story = {
  ...
  render: () => ({
    template: `
      <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;padding:24px;background:var(--bg-0)">
        <ds-button variant="primary" size="sm" label="Log set">${ARROW_ICON}</ds-button>
        <ds-button variant="primary" size="md" label="Log set">${ARROW_ICON}</ds-button>
        <ds-button variant="primary" size="lg" label="Start session">${ARROW_ICON}</ds-button>
      </div>
    `,
    moduleMetadata: { imports: [ButtonComponent] },
  }),
